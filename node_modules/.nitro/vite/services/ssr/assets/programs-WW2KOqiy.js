import { o as journey, r as courses } from "./site-data-B3dZqpQp.js";
import { r as Button } from "./router-TqFQiJeJ.js";
import { n as SectionHeading, t as Section } from "./Section-CXu6bqw9.js";
import { t as CTASection } from "./CTASection-Dgy2fcwV.js";
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
			...
			children: programs.map((p) => /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("ul", {
						...
						children: p.points.map((pt) => /* @__PURE__ */ jsxs("li", {
		...
		/* @__PURE__ */ jsxs(Section, {
			...
			children: [/* @__PURE__ */ jsx(SectionHeading, {
				...
				children: courses.map((c) => /* @__PURE__ */ jsx(Button, {
					asChild: true,
					variant: "outline",
		...
		/* @__PURE__ */ jsxs(Section, { children: [/* @__PURE__ */ jsx(SectionHeading, {
			...
			children: journey.map((s) => /* @__PURE__ */ jsxs("li", {
